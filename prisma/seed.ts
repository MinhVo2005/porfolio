...
async function main() {
  ...
  await db.experience.create({
    data: {
      ...
      order: 0,
      skills: {
        connect: [skill("Svelte"), skill("TailwindCSS"), skill("Git")],
      },
    },
  });
  ...
  await db.experience.create({
    data: {
      ...
      description:
        "Worked in a fast-paced environment, maintaining speed, preparation, and organization during peak service hours.",
  ...
  await db.project.create({
    data: {
      ...
      order: 3,
      skills: {
        connect: [skill("Python"), skill("BrickPi 3"), skill("Raspberry Pi"), skill("Git"), skill("Linux")],
      },
    },
  });
  ...
  await db.project.create({
    data: {
      ...
      description:
        "Developed a fully functional music bot that can search, play, pause, and skip songs in the queue. Built with JavaScript, discord.js, and NPM libraries for song search and playback.",
      featured: false,
      order: 4,
      skills: {
        connect: [skill("JavaScript"), skill("NodeJS")],
      },
    },
  });
